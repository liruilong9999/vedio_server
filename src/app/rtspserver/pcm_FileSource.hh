...
#ifndef _PCM_FILE_SOURCE_HH
#define _PCM_FILE_SOURCE_HH
...
class pcm_FileSource: public AudioInputDevice {
public:

  static pcm_FileSource* createNew(UsageEnvironment& env,
					char const* fileName);
...
protected:
  pcm_FileSource(UsageEnvironment& env, FILE* fid);
	// called only by createNew()

  virtual ~pcm_FileSource();
